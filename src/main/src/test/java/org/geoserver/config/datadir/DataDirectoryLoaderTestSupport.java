...
class DataDirectoryLoaderTestSupport {
    ...
    public static DataDirectoryLoaderTestSupport withNoPersistence(File dataDirectory) {
        ...
        DataDirectoryLoaderTestSupport support = new DataDirectoryLoaderTestSupport(tmpCatalog, tmpGeoServer);
        //        support.setUpServiceLoaders();
        //        tmpGeoServer.removeListener(tmpGeoServer.getListeners().stream()
