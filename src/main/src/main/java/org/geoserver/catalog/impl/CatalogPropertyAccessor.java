...
public class CatalogPropertyAccessor implements PropertyAccessor {
    ...
    private Object getProperty(
            final Object input, final PropertyNames propertyNames, final int propertyIndex)
            throws IllegalArgumentException {
        ...
        if (null == input) {
            ...
            //                    "Property not found: " +
            // Joiner.on('.').join(Arrays.copyOf(propertyNames, propertyIndex + 1)));
            throw new IllegalArgumentException(
                    "Property not found: " + propertyNames.qualifiedName());
        }
            ...
            if (!((Map<?, ?>) input).containsKey(propName)) {
                throw new IllegalArgumentException(
                        "Property "
                                ...
                                + (propertyIndex > 0
                                        ? propertyNames.singleName(propertyIndex - 1)
                                        : ""));
            }
    ...
    private Object getIndexedProperty(
            Object input, final PropertyNames propertyNames, final int offset) {
