...
final class IsolatedCatalogFacade implements CatalogFacade {
    ...
    public <T extends StoreInfo> T getStoreByName(
        ...
        return canSeeWorkspace(workspace, getLocalWorkspace())
                ? facade.getStoreByName(workspace, name, clazz)
                : null;
    }
    ...
    public <T extends CatalogInfo> int count(Class<T> of, Filter filter) {
        ...
        //        CloseableIterator<T> found = facade.list(of, filter, null, null);//REVISIT: found
        // is not closed
     ...
     */
    private boolean canSeeWorkspace(
            WorkspaceInfo workspace, @Nullable WorkspaceInfo localWorkspace) {
