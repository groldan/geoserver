...
public abstract class HTTPStoreInfoImpl extends StoreInfoImpl implements HTTPStoreInfo {
    ...
    protected HTTPStoreInfoImpl() {}

    public HTTPStoreInfoImpl(Catalog catalog) {
        super(catalog);
    }
    ...
    @Override
    public int hashCode() {
        return HTTPStoreInfo.hashCode(this);
    }

    @Override
    public boolean equals(Object obj) {
        return HTTPStoreInfo.equals(this, obj);
    }
}
