...
/**
 * Helper class used to create mock objects during GeoServer testing with additional security settings.
 */
public class MockSecurityCreator extends MockCreator{

    public GeoServerSecurityManager createSecurityManager(MockSecurityTestData testData) throws Exception {
