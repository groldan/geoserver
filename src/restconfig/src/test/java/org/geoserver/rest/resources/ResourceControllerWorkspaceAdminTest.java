...
public class ResourceControllerWorkspaceAdminTest extends GeoServerSystemTestSupport {
    ...
    public void testUploadToOtherWorkspaceDenied() throws Exception {
        ...
        // TODO: should return 403 but SecureResourceStore.out() throws IllegalStateException
        // which ResourceController doesn't catch, resulting in 500
        assertTrue(
                "Should deny write to other workspace, got " + response.getStatus(),
                response.getStatus() == 403 || response.getStatus() == 500);
