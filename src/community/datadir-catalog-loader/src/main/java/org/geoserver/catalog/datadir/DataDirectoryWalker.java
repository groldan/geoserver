...
class DataDirectoryWalker {
    ...
    static class WorkspaceDirectory {
        public final Path workspaceFile;
        public final Path namespaceFile;
        public final Optional<Path> settings;
        public final Set<String> serviceInfoFileNames;
    ...
    static class StoreDirectory {
        ...
        public Stream<LayerDirectory> layers() {
            return walker.layers(storeFile.getParent());
        }
    }
    ...
    public DataDirectoryWalker(Path dataDirRoot, List<String> serviceFileNames) {
