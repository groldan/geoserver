...
public class AclContainerIntegrationTest extends GeoServerSystemTestSupport {
    ...
    /**
     * Note since GeoServerSystemTestSupport uses Junit4 we can't use the @TestContainers @Container annotations from
     * testcontainers:junit-jupiter, hence manual start()/stop()
     */
